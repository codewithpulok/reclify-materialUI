...
import { useCancelTransactionMutation } from 'src/redux-toolkit/services/adminApi';
 ...
 * @returns {JSX.Element}
 */
const CancelTransactionAdminDialog = (props) => {
...
CancelTransactionAdminDialog.propTypes = Props;

export default CancelTransactionAdminDialog;
