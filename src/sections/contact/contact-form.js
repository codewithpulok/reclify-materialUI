  ...
  return (
    <Stack component={MotionViewport} spacing={5}>
      <Stack spacing={1}>
        ...
        <Typography>
          We welcome your inquiries and are eager to assist you here at Racklify. Whether
          you&apos;re a warehouse or service provider seeking to join our esteemed platform or an
          individual in search of warehouse space, our team is ready to provide the support you
          need.{' '}
        </Typography>
        <Typography>
